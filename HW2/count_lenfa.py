...
F1=open("lenfaup.txt",'r',encoding="UTF-8")
F2=open("lenfadown.txt",'r',encoding="UTF-8")
F3=open("lenfanews.txt",'r',encoding="UTF-8")
F10=open("typ_lenfa.txt",'r',encoding="UTF-8")

F7=open("result_lenfa","w",encoding="UTF-8")
F8=open("nonodata_typ_lenfa","w",encoding="UTF-8")
F9=open("nonodata_target","w",encoding="UTF-8")
